...
class OffboardControl(Node):
        ...
        def __init__(self) -> None:
                super().__init__('drone_takeoff_and_land')
        ...
        def timer_callback(self) -> None:
                ...
                if self.vehicle_local_position.z > self.takeoff_height  and self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
                        self.publish_position_setpoint(0.00, 0.00, self.takeoff_height)

                        if self.vehicle_local_position.z < self.takeoff_height + 0.1 and self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
                                self.publish_position_setpoint(15.00, 15.00, self.takeoff_height)
